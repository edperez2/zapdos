...
#include "IonHeatingBC.h"

registerADMooseObject("ZapdosApp", IonHeatingBC);

InputParameters
IonHeatingBC::validParams()
{
  ...
  params.addRequiredCoupledVar("mean_en", "The average electron energy");
  params.addRequiredCoupledVar("em", "The electron density.");
  params.addRequiredCoupledVar("ip", "The ion density.");
  params.addRequiredParam<Real>("position_units", "Units of position.");
  params.addRequiredParam<Real>("ionization_energy", "The ionization energy of this species"); //new change
  return params;
}

IonHeatingBC::IonHeatingBC(const InputParameters & parameters)
  : ADIntegratedBC(parameters),
    _r_units(1. / getParam<Real>("position_units")),
    _r(getParam<Real>("r")),
    _r_ion(getParam<Real>("r_ion")),
    _ionization_energy(getParam<Real>("ionization_energy")), //new change
...
ADReal
IonHeatingBC::computeQpResidual()
{
